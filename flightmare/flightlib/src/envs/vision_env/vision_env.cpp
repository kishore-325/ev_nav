...
void VisionEnv::init() {
  ...
  if (_datagen){
    ...
    // set _numRun according to the digit found at the end of env_folder_
    _numRun = std::stoi(env_folder_.substr(env_folder_.find_last_of('_') + 1));
