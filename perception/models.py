...
class ResNeXt50UNet(nn.Module):
    """
    ResNeXt50 encoder + UNet-style decoder with ConvLSTM at bottleneck.
    ...
    def __init__(self, input_mode=1, evs_min_cutoff=0,
        ...
        self.dec4 = DecoderBlock(lstm_hidden_dim, 1024, 256)
    ...
    def forward(self, x, h=None):
        ...
        #Encoder
        f0, f1, f2, f3, f4 = self.encoder(im)         # 64, 256, 512, 1024, 2048 ch
