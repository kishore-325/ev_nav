...
class OrigUNet(nn.Module):
    ...
    def __init__(self, input_mode=1, evs_min_cutoff=0, lstm_kernel_size=1, lstm_hidden_dim=512):
        super().__init__()
        ...
        self.upconv1 = nn.ConvTranspose2d(lstm_hidden_dim, 256, kernel_size=2, stride=2)  # (N,256,16,26)
        ...
        self.lstm = ConvLSTM(input_dim=512, hidden_dim=[lstm_hidden_dim], num_layers=1,
                             kernel_size=(lstm_kernel_size, lstm_kernel_size), bias=False,
    ...
    def forward(self, x, h=None):
        ...
        returns: (depth, h_new)
            depth: (N, 1, 260, 346) depth map (raw logits, no sigmoid)
